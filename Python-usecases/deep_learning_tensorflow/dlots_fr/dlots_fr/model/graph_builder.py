...
class GraphBuilder(object):
    ...
    def _declare_inputs():
        ...
        return x_batch, y_batch, x_length

    def _inference(self, x_batch, y_batch, x_length):
        """
        Build graph.
        :param x_batch:
        :param y_batch:
        ...
        context = tf.Variable(tf.truncated_normal([Config.context_size, 1],
                                                  stddev=0.01,
                                                  dtype=tf.float32))
        ...
        # Final stage
        output_dim = y_batch.get_shape()[1]
        final_output = model_output(predicted_input, output_dim)
    ...
    def _build_model_for_train(self):
        ...
        """
        x_batch, y_batch, x_length = self._declare_inputs()
        pred_output = self._inference(x_batch, y_batch, x_length)

...
class AppConfigSchedule(Base):
    ...
    def __init__(self,configID,storageInfo,machineInfo,
                 networkInfo,routerInfo):
...
class RouterType(Base):
    ...
    def __init__(self,typeID,inbw,outbw,buff,capacity,
                 connector = "",version = ""):
...
class MachineType(Base):
    ...
    def __init__(self,typeID,numcpu,numcore,frequency,numfpga,
                 memfpga,numgpu,memory,disk,typegpu = "",typefpga = ""):
